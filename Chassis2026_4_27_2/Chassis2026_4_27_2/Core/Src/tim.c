...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = M3_ENCODER_A_Pin|M3_ENCODER_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM5_MspInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    GPIO_InitStruct.Pin = M4_ENCODER_A_Pin|M4_ENCODER_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM12_MspPostInit 0 */
    ...
    PB15     ------> TIM12_CH2
    */
    GPIO_InitStruct.Pin = work1_Pin|work2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, M3_ENCODER_A_Pin|M3_ENCODER_B_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, M4_ENCODER_A_Pin|M4_ENCODER_B_Pin);
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
	...
	{
			Get_encoder();
			if(MOVE_STATE==1&&(start_yaw!=0))
			{
					Move();
//				mike_wheel(0,speed,0);
//				pid_motor_speed[1].set=speed;
